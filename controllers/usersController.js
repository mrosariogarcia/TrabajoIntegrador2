...
let usersController = {
    ...
    edit: function (req, res) {
        ...
        const cargarinfo = {};
        cargarinfo.email = req.body.email
        cargarinfo.usuario = req.body.usuario
        cargarinfo.fechaDeNacimiento = req.body.fechaDeNacimiento
        cargarinfo.dni = req.body.dni
        cargarinfo.fotoDePerfil = "/images/users/" + req.body.fotoDePerfil
        cargarinfo.recordarme = req.body.recordarme
        cargarinfo.updatedAt = new Date();


        // Actualizar la contraseña solo si se cambia en el formulario
        if (req.body.contrasena) {
            cargarinfo.contrasena = bcrypt.hashSync(req.body.contrasena, 10);
        }

        db.User.update(cargarinfo,
